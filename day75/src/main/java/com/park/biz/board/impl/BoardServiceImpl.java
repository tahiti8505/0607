...
public class BoardServiceImpl implements BoardService {
	...
	@Override
	public List<BoardVO> selectAllBoardT(BoardVO vo) {
		return boardDAO.selectAllBoardT(vo);
	}
	@Override
	public List<BoardVO> selectAllBoardW(BoardVO vo) {
		return boardDAO.selectAllBoardW(vo);
	}
}
