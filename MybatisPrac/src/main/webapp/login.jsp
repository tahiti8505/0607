									...
									<div class="content">
										...
										<table class="alt">
												<tbody>
													...
													<tr>
														<td colspan="3" align="right"><input type="submit" class="button primary" value="<spring:message code="message.introduction.login" />"> <a href="signup.do" class="button primary"><spring:message code="message.introduction.sign" /></a> </td>
													</tr>
												</tbody>
										</table>
										</form>
